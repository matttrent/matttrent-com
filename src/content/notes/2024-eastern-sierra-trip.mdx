...
<MarginNote name="other" num={false}><img src="/images/DSCF1631.jpg"/>This is a caption</MarginNote>
Tufte emphasizes tight integration of graphics with text. Data, graphs, and figures are kept with the text that discusses them. In print, this means they are not relegated to a separate page. On the web, that means readability of graphics and their accompanying text without extra clicks, tab-switching, or scrolling.



<MarginNote name="testing" num={false} >Adding some text inside of here. but what happens if this text is much much longer than the body element it matches how do theings </MarginNote>
...
<BasicImage>
  ...
  <MarginNote slot="sidenote" name="exports-imports" num={false}>
