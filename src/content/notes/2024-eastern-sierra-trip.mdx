...
<BasicImage>
  ...
  <MarginNote slot="marginnote" name="exports-imports">
    <span>From Edward Tufte, <em>Visual Display of Quantitative Information</em>, page 92.</span>
  </MarginNote>
</BasicImage>
...
<MarginNoteMD>
  ...
  <MarginNote slot="marginnote" name="rhino">
